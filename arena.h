/*
 * arena.h — stb-style single-header arena allocator
 *
 * Usage:
 *   #define ARENA_IMPLEMENTATION
 *   #include "arena.h"
 *
 * in exactly one C file. Include without the define elsewhere for declarations only.
 *
 * Based on code from: https://github.com/Magicalbat/videos
 */
...
#ifndef ARENA_TYPES_DEFINED
#define ARENA_TYPES_DEFINED
typedef int8_t   i8;
typedef int16_t  i16;
typedef int32_t  i32;
typedef int64_t  i64;
